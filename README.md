...
progress across day/week/month/year views, jot down dated intentions in
**Will Do**, manage a shopping list, and see real statistics — all fully
offline, with **your data staying on your device**. No account, no backend,
no tracking.
...
## 7. Browser limitations to be aware of

- **No background sync** — carry-forward only runs while the app is open
  (it re-checks every time you reopen it).
...
## 8. Future features that would require a backend
